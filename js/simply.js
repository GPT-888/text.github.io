      ...
      $.ajax({
        ...
        success: function (res) {
          if (typeof (res) === 'string') {
            layer.msg('澶揩浜嗗惂~杩囦竴浼氬効鍐嶆潵');
            return;
          }
          if (typeof (res) === 'object' && res.code !== 0) {
            layer.msg('璇勮澶辫触~璇疯仈绯荤鐞嗗憳');
            return;
          }
          if (typeof (res) === 'object' && res.code == 0) {
            layer.msg('鍙戦€佹垚鍔焴');
